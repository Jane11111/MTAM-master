...
class Get_amazon_data_pet(Get_origin_data_base):

    def __init__(self, FLAGS):

        super(Get_amazon_data_pet, self).__init__(FLAGS = FLAGS)

        self.raw_data_path = "data/raw_data/amazon_pet/Pet_Supplies.json"
        self.raw_data_path_meta = "data/raw_data/amazon_pet/meta_Pet_Supplies.json"

        self.data_path = "data/orgin_data/pet.csv"
