...
class Get_yoochoose_data_small(Get_origin_data_base):

    def __init__(self, FLAGS):

        super(Get_yoochoose_data_small, self).__init__(FLAGS = FLAGS)
        self.data_path = "data/orgin_data/yoochoose_small.csv"
    ...
    def get_yoochoose_data(self):
        ...
        userfiltered = user_filter.sample(frac = 0.015625)
