...
class base_model_time(object):
    ...
    def train(self, sess, batch_data, learning_rate, add_summary=False, global_step=0, epoch=0):
        ...
        output_feed = [self.loss, self.loss_origin,self.loss_time , self.merged, self.train_op]
    ...
    def output(self):
        with tf.name_scope('CrossEntropyLoss'):
            ...
            # logits = logits + predict_is_reconsume * self.reconsume_scores
